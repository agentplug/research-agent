...
class ModeSelector:
    ...
    def select_mode(self, query: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            if not self.enabled:
                return self._create_result(self.fallback_mode, "Mode selection disabled")
        ...
        try:
            ...
            for mode in self.modes:
                ...
                recommendations[mode] = {
                    ...
                    'reason': self._get_mode_reason(mode, complexity_score, pattern_mode)
                }
            ...
            return self.error_handler.handle_error(
                e,
                {'query': query},
                f"Error generating mode recommendations: {str(e)}"
            )

...
class ModelConfig:
    ...
    PREFERRED_MODELS = [
        ...
        "gemma:latest",
        "llama3.1:latest",  # General purpose models
        "qwen3:latest",
...
@dataclass
class SessionInfo:
    """Data class for research session information."""
...
@dataclass
class ResearchData:
    """Data class for structured research data."""
...
class IntermediateResult:
    """Data class for intermediate research result."""

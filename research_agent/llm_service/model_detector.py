"""
Model Detection and Scoring for Research Agent LLM Service
...
class ModelDetector:
    ...
    def detect_best_model(self) -> str:
        ...
        Returns:
            Model identifier string (e.g., "ollama:llama3.1:8b")
        """
    ...
    def _detect_ollama_url(self) -> str:
        """Detect Ollama API URL by checking availability."""
        # Check environment variable first
        env_url = os.getenv("OLLAMA_API_URL")
        if env_url:
            return env_url

        # Try common URLs and check availability
    ...
    def _detect_lmstudio_url(self) -> str:
        """Detect LM Studio API URL by checking availability."""
        # Check environment variable first
    ...
    def create_model_info(
        self, model_name: str, is_local: bool = True, url: Optional[str] = None
    ) -> ModelInfo:

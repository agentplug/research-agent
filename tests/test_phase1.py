...
class TestResearchAgent(unittest.TestCase):
    ...
    def test_instant_research(self):
        ...
        request = {"method": "instant_research", "query": "What is AI?"}
    ...
    def test_quick_research(self):
        ...
        request = {"method": "quick_research", "query": "How does ML work?"}
        response = self.agent.handle_request(request)
        self.assertTrue(response["success"])
    ...
    def test_standard_research(self):
        ...
        request = {"method": "standard_research", "query": "Latest AI developments"}
        response = self.agent.handle_request(request)
        self.assertTrue(response["success"])
    ...
    def test_deep_research(self):
        ...
        request = {"method": "deep_research", "query": "AI impact on society"}
        response = self.agent.handle_request(request)
        self.assertTrue(response["success"])
    ...
    def test_research_history(self):
        ...
        # Perform a research
        request = {"method": "instant_research", "query": "Test query"}
...
class TestResearchAgentHub(unittest.TestCase):
    ...
    def setUp(self):
        ...
        config_data = {"ai": {"temperature": 0.1}, "research": {"max_rounds": 10}}

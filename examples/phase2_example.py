...
print(f"Content: {instant_result['data']['content'][:200]}...")
print()
...
print(f"Content: {quick_result['data']['content'][:200]}...")
print()

# Test standard research
print("=== STANDARD RESEARCH ===")
standard_result = agent.standard_research(query="What are the latest developments in AI?")
print(f"Success: {standard_result['success']}")
print(f"Rounds: {standard_result['data']['research_rounds']}")
print(f"Content: {standard_result['data']['content'][:200]}...")
print()
...
print(f"Content: {deep_result['data']['content'][:200]}...")
print()
